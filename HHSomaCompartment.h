...
{
	struct Compartment SUPERCLASS_HHSOMACOMPARTMENT_OBJECT_NAME;                // HHSomaCompartment : Compartment
...
{
	struct CompartmentClass SUPERCLASS_HHSOMACOMPARTMENT_CLASS_NAME; // HHSomaCompartmentClass : CompartmentClass
};
