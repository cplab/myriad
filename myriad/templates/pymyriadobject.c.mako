<%! import sys %>
#include <python${sys.version_info.major}.${sys.version_info.minor}/Python.h>
#include <python${sys.version_info.major}.${sys.version_info.minor}/modsupport.h>
#include <python${sys.version_info.major}.${sys.version_info.minor}/structmember.h>
