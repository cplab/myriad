...
class CTypesTester(unittest.TestCase):
    ...
    def test_CList(self):
        ...
        parsed = ast_stringify.stringify_literal(code.body[0].value)
    ...
    def test_CSubscript(self):
        code = ast.parse("l[0]")
        parsed = ast_stringify.stringify_subscript(code.body[0].value)
    ...
    def test_CVar(self):
        code = ast.parse("a")
        parsed = ast_stringify.stringify_var(code.body[0].value)
    ...
    def test_CVarAttr(self):
        ...
        parsed = ast_stringify.stringify_attribute(code.body[0].value)
        self.assertEqual(parsed.var, "a")
